# Source Metadata
**URL:** https://tfx.treasury.gov/tfm/volume1/part5/chapter-2000-depositing-domestic-checks-and-cash-received-over-counter-otc
**Date Extracted:** 2026
...
:   **2025.10—All Electronic Collections Guidance (General)**
    ...
    **2025.30—Exception/Waiver Request Process**
    ...
    Federal agencies may apply to Fiscal Service to continue to receive federal collections by check through any method (e.g., OTCnet, ECP, or lockbox). Individual waivers will be managed by the responsible federal agency, not Fiscal Service. To apply for the waiver, the agency must submit a request to [**EO14247@fiscal.treasury.gov**](mailto:EO14247@fiscal.treasury.gov). The waiver request must provide the following information:
    ...
    * Agency point of contact (POC), name, title, business email address, and business phone number.
    ...
    [**EO14247@fiscal.treasury.gov**](mailto:EO14247@fiscal.treasury.gov).
...
:   **2030.10—Deposit Reporting**
    ...
    **2030.20—Designated FIs for TGA Deposits**
    ...
    [**Note**: For ACH or Fedwire deposits, federal entities should refer to [**TFM** **Volume I, Part 5, Chapter 7500**](https://tfx.treasury.gov/tfm/volume1/part5/chapter-7500-credit-gateway-fedwire-and-automated-clearing-house-ach-credit), “Fedwire and Automated Clearing House (ACH) Credit Deposits to the Account of the Bureau of the Fiscal Service”.]
    ...
    **2030.40—Reporting Large Deposits**
    ...
    Federal entities must report daily aggregate deposits (excluding Treasury checks) of $50 million or more to the Bureau of the Fiscal Service’s Cash Reporting Branch. See "Cash Forecasting Requirements" chapter at[**TFM Volume I, Part 6, Chapter 8500**](https://tfx.treasury.gov/tfm/volume1/part6/chapter-8500-cash-forecasting-requirements)**,**section 8530, for instructions. However, federal entities must not accept any check written for more than $99,999,999.99, as the Federal Reserve Banks will not process checks over that amount. See [**Federal Reserve Banks Operating Circular 3**](https://www.frbservices.org/binaries/content/assets/crsocms/resources/rules-regulations/110121-operating-circular-3-redlined.pdf), “Collection of Cash Items and Returned Checks,” section 3.3.
...
:   **2035.10—Record of Checks Received**
    ...
    * Serial number (if postal money order).
    ...
    If a check is lost, mutilated, or destroyed, refer to the instructions in [**TFM Volume I, Part 5, Chapter 5000**](https://tfx.treasury.gov/tfm/volume1/part5/chapter-5000-unpaid-checks), Section 5035 (Uncollected, Lost, Destroyed, and Mutilated Checks).
...
:   Fiscal Service is committed to maximizing electronic revenue collection options to ensure timely deposits to fund the federal government. Federal entities should utilize OTCnet Check Capture and/or Mobile Check Capture for all checks received. These solutions accelerate the deposit processing, and the deposit of funds into the Treasury’s account**.**
    ...
    * Is affected by an environmental limitation that prevents the physical delivery of the federal deposits.
    ...
    Additionally, when temporarily switching to the CMITGA process, the affected federal entity should email their federal entity location name, address and ALC to [**govlbxcustsvc@usbank.com**](mailto:govlbxcustsvc@usbank.com).
...
:   **Direct inquiries concerning this chapter to:**  
    ...
    Landover, MD 20785  
    Email: [**TGAops@fiscal.treasury.gov**](mailto:TGAops@fiscal.treasury.gov)

    Federal Reserve Bank of St. Louis  
    OTC Support Team Telephone: 866-771-1842  
    Email: [**stls.tga.support@stls.frb.org**](mailto:stls.tga.support@stls.frb.org)  
      
    **Direct inquiries concerning counterfeit currency to:**  
      
    [**Secret Service**](https://www.secretservice.gov/)  
    [**U.S. Currency**](https://www.uscurrency.gov/)
...
:   |  |  |  |
    ...
    | 2025.10 | All Electronic Collections Guidance (General) | Added new section. |
    | 2025.20 | Exceptions and Waivers from Electronic Collections Requirements | Added new section. |
    | 2025.30 | Exception/Waiver Request Process | Added new section. |
    | 2035.10 | Records of Checks Received | Updated language. |